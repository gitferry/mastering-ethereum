...
到此我们就完成了全部的代码，完整代码可以在 [github](https://github.com/gitferry/mastering-ethereum/tree/master/web3-interact-with-Solidity) 中找到。在浏览器中打开``index.html``测试效果如下图（输入名字和年龄后刷新）。
